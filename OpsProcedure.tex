...
Use the DUNE Ignition, make sure no other valves in the thermosyphon system are being controlled.
...
Fill the numbers 10L at 10 slpm, and click \texttt{Add LN$_2$}.  Click on the pressure graph below 
the value of liters to check the pressure  \\
...
\myCheckBox{Removed liquid nitrogen in the thermosyphon line} & One way to do so is to remove 1000~L of 
